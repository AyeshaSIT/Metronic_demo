...
<div class="app-sidebar-logo px-6 d-flex justify-content-center align-items-center" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="{{ image('logos/custom-2.png') }}" class="h-50px w-50px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('logos/custom-2.png') }}" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
